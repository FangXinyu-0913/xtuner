...
# laion_visual_encoder_name_or_path = '/cpfs01/shared/llmeval/fangxinyu/hub/models--laion--CLIP-ViT-L-14-DataComp.XL-s13B-b90K' 
viclip_visual_encoder_name_or_path = '/cpfs01/shared/llmeval/fangxinyu/hub/models--OpenGVLab--ViCLIP' #'/cpfs01/shared/llmeval/dhd/hub/models--laion--CLIP-ViT-L-14-DataComp.XL-s13B-b90K' #'openai/clip-vit-large-patch14-336'
...
image_processor = dict(
    ...
    pretrained_model_name_or_path=viclip_visual_encoder_name_or_path,
    trust_remote_code=True)
