...
visual_encoder_name_or_path = '/cpfs01/shared/llmeval/fangxinyu/hub/models--laion--CLIP-ViT-L-14-DataComp.XL-s13B-b90K' #'openai/clip-vit-large-patch14-336' #'/cpfs01/shared/llmeval/dhd/hub/models--laion--CLIP-ViT-L-14-DataComp.XL-s13B-b90K' #'openai/clip-vit-large-patch14-336'
# Specify the pretrained pth, temp using https://huggingface.co/liuhaotian/llava-336px-pretrain-llama-2-7b-chats
pretrained_pth = '/cpfs01/user/fangxinyu/xtuner/work_dirs/llava_internlm2_chat_7b_laion_clip_vit_large_p14_224_e1_gpu8_pretrain_video_16f/iter_23131.pth'  # noqa: E501
...
video_data_path = '/cpfs01/user/fangxinyu/Video-LLaVA/data/train_json/videochatgpt_llavaimage_tune_sampledMinor.json' #modify_shuffle_v2
...
# offline_data_folder_full='/cpfs01/shared/llmeval/fangxinyu/video_related_data/xtuner_offline_data/videochatgpt_llavaimage_tune_modify_shuffle_v2_internlm2_7b_2048l_llava_map_fn_offline'
...
frame_size = 224 
pixel_size = 14
max_length = int(1500) #text max length, the same with previous situation
