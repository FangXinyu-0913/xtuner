...
pretrained_pth = '/cpfs01/user/fangxinyu/xtuner/work_dirs/llava_internlm2_chat_7b_laion_clip_vit_large_p14_224_e1_gpu8_pretrain_video_128f1792L_testunivi/iter_11530.pth'  # noqa: E501
...
offline_data_folder_full='/cpfs01/shared/llmeval/fangxinyu/video_related_data/xtuner_offline_data/videochatgpt_llavaimage_tune_modify_shuffle_v2_internlm2_7b_1792l_llava_map_fn_offline'
...
frame_size = 224 
pixel_size = 14
max_length = int(1792) #text max length, the same with previous situation
