...
from xtuner.dataset.map_fns import llava_map_fn, template_map_fn_factory, llava_videochat_sft_map_fn
...
visual_encoder_name_or_path = '/cpfs01/shared/llmeval/fangxinyu/hub/models--laion--CLIP-ViT-L-14-DataComp.XL-s13B-b90K' #'/cpfs01/shared/llmeval/dhd/hub/models--laion--CLIP-ViT-L-14-DataComp.XL-s13B-b90K' #'openai/clip-vit-large-patch14-336'
...
videochat_data_path = '/cpfs01/shared/llmeval/fangxinyu/video_related_data/videochat_sft/videochat_instruct_11k.json'
videochat_folder = '/cpfs01/shared/llmeval/fangxinyu/video_related_data/videochat_sft/WebVid10M'
...
# videochat_dataset = dict(
#     type=LLaVADataset,
#     # offline_processed_text_folder=offline_data_folder_full,
#     data_path=data_path,
#     image_folder=image_folder,
#     video_data_path = videochat_data_path,
#     video_folder = videochat_folder,
#     tokenizer=tokenizer,
#     image_processor=image_processor,
#     dataset_map_fn=llava_videochat_sft_map_fn,
#     template_map_fn=dict(
#         type=template_map_fn_factory, template=prompt_template),
#     video_frames=video_frames,
#     video_batch_size=video_batch_size,
...
# train_dataset = dict(
#     type=ConcatDataset, datasets=[llava_dataset, videochat_dataset])

train_dataset = dict(
    type=ConcatDataset, datasets=[llava_dataset])
