...
class ChatUniViMetaForCausalLM(BaseModel):
    ...
    #     image_features = self.get_vision_tower()(images, select_feature="patch")
    ...
    def forward(self, image_features, input_type="image"):
        if input_type == "image":
            ...
            token_dict = self.block2(self.ctm2(token_dict))
            cluster_image_features.append(token_dict["x"])
            ...
            down_dict, token_dict = self.ctm3(token_dict)
            events = OrderedDict()
            ...
            token_dict0 = self.block0(self.ctm0(token_dict))
            token_dict1 = self.block1(self.ctm1(token_dict0))
            token_dict2 = self.block2(self.ctm2(token_dict1))
            ...
            for id, key in enumerate(events):
                ...
                cur_token_dict0 = self.block0(self.ctm0(token_dict))
                ...
                cur_token_dict1 = self.block1(self.ctm1(token_dict))
                ...
                cur_token_dict2 = self.block2(self.ctm2(token_dict))
